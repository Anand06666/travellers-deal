            ...
            <div className="container mx-auto px-4 mb-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-2 h-[300px] md:h-[450px] rounded-2xl overflow-hidden relative group">
                    ...
                    <div className="md:col-span-2 h-full relative cursor-pointer">
                        <img src={experience.images?.[0] || 'https://via.placeholder.com/800x600'} alt={experience.title} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                    </div>
                    {/* Side Images */}
                    <div className="hidden md:block h-full cursor-pointer">
                        <img src={experience.images?.[1] || experience.images?.[0] || 'https://via.placeholder.com/400x300'} alt="Gallery 2" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                    </div>
                    <div className="hidden md:flex flex-col gap-2 h-full">
                        <div className="flex-1 overflow-hidden cursor-pointer">
                            <img src={experience.images?.[2] || experience.images?.[0] || 'https://via.placeholder.com/400x300'} alt="Gallery 3" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                        </div>
                        <div className="flex-1 overflow-hidden cursor-pointer relative">
                            <img src={experience.images?.[3] || experience.images?.[0] || 'https://via.placeholder.com/400x300'} alt="Gallery 4" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
